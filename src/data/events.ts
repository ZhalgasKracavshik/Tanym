...
export const EVENTS: SchoolEvent[] = [
  ...
  },
  {
    ...
    description:
      'Двухнедельный интенсив по олимпиадной математике. Событие уже прошло — оставлено в афише, чтобы можно было посмотреть формат и подготовиться к следующему набору.',
    startsAt: '2026-07-05',
