  ...
  */
  ...
  return (
    <div className="mx-auto max-w-4xl px-4 py-10 sm:px-6">
      ...
      */}
      {/*
        Пояснения «рейтинг ведут ученики» здесь больше нет.

        Оно объясняло то, что и так видно: в таблице стоят ученики, у
        учителя своей строки нет. Отдельная карточка внизу страницы
        сообщала это ещё раз словами и читалась как оправдание за
        отсутствие, которого никто не заметил.
      */}
      {me ? null : (
        <div className="mt-16">
