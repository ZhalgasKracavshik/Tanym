...
/**
 * Набор символов для аватара.
 *
 * Не весь эмодзи-справочник, а короткий список: животные, космос, спорт,
 * учёба и природа. Полный набор превратил бы выбор в поиск, а половина
 * его содержимого (флаги, жесты, лица) в школьном профиле лишняя.
 */
