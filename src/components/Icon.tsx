...
const PATHS: Record<IconName, React.ReactNode> = {
  ...
  /* Колба: горлышко, расширяющиеся стенки и линия жидкости. */
  chemistry: (
    <>
      <path d="M9.5 3h5" />
  ...
  /* Лист с центральной жилкой — узнаётся при 16 пикселях, в отличие от ДНК. */
  biology: (
    <>
      <path d="M4.5 19.5C3 15 5 7.5 12.5 5c2.5-.8 5-1 7-1 0 2.5-.3 5.2-1.2 7.6C15.6 18.6 9 20.5 4.5 19.5Z" />
      <path d="M4.5 19.5C7 16 10.5 12.5 15.5 9.5" />
    </>
  ),
  /* Раскрытая книга с закладкой: язык — про чтение, а не про флаг страны. */
  english: (
    <>
